...
- **Siguiente en este repo** (prioridad **demo navegable por slices**, ver `docs/DEVPLAN.md`): **POC.4.5** (**AQUÍ ESTAMOS** — modales asignación / insumos / cancel / reproceso). Acciones directas ya en **`ServiceActionBar`**; **[BACKEND]** POC.4 para transiciones reales.
