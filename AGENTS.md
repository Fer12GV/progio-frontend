...
- **Siguiente en este repo** (prioridad **demo navegable por slices**, ver `docs/DEVPLAN.md`): **POC.5.4** (**AQUÍ ESTAMOS** — prefactura tras cerrar). Bloqueo **Cerrar** sin pref. `valid` (**POC.5.3** ✓). **[BACKEND]** POC.4 / POC.5 para datos reales.
