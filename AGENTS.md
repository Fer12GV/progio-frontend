...
- **Siguiente en este repo** (prioridad **demo navegable por slices**, ver `docs/DEVPLAN.md`): **POC.6.3** (**AQUÍ ESTAMOS** — scroll táctil). Barra operario táctil (**POC.6.2** ✓). **[BACKEND]** POC.4/5 sigue siendo el refuerzo ideal para datos reales y `operator_id` en listados.
